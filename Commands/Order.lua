-- Commands/Order.lua
-- Aurora Logger + Auto Webhook System
-- (Vulcano Compatible + Base64 Manual + GitHub Auto Update JSON)
...
return {
    Execute = function(tab)
        ...
        -------------------------------------------------
        -- 🔹 Manual Base64 Encoder (untuk Vulcano)
        -------------------------------------------------
            ...
            local payload = {
                embeds = {{
                    ...
                    fields = {
                        ...
                        { name = "☁️ Weather", value = weather.Value, inline = true },
                    },
